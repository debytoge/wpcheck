...
Copyright Â© 2021 Andrew <andrevirdiaz@gmail.com>
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
      ...
      epilog="Copyright Â© 2021 Andrew - Powered by Indonesian Darknet",
    )
    ...
    try:
        ...
        with ThreadPoolExecutor(max_workers=args.thread) as executor:
            ...
            if success_login is True:
                ...
                open('hasil.txt', 'a+').write(args.url+ "/wp-login.php "+args.usr+" "+password+ "\n")
            else:
